  ...
  return (
    <section className="mx-5 mb-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_8px_24px_rgba(15,23,42,0.05)]" aria-labelledby="local-services-title">
      <h2 id="local-services-title" className="text-lg font-semibold tracking-tight text-[var(--brand-navy)]">
        Servicios y mandados en {location}
      </h2>
      <p className="mt-2 text-sm leading-6 text-slate-600">
        <strong>Servicios</strong> te ayuda a encontrar proveedores locales en {location}. Consulta su cobertura, disponibilidad y precios de referencia antes de contactar directamente por WhatsApp o llamada. El proveedor realiza el servicio y confirma contigo el precio final.
      </p>

      <div className="mt-4 border-t border-slate-200 pt-4">
        <p className="text-sm font-semibold text-[var(--brand-navy)]">¿Tienes dudas sobre precios, cobertura o contacto?</p>
