...
export default function TermsPage() {
  return (
    <LegalPageLayout title="Términos y Condiciones">
      ...
      <p>Servicios es una plataforma digital que facilita el contacto entre personas que buscan determinados servicios y prestadores independientes que los ofrecen. Al acceder o utilizar la plataforma, aceptas utilizarla de manera responsable y conforme a estos términos.</p>

      <h2>2. Naturaleza de la plataforma</h2>
      <p>Servicios funciona principalmente como un medio para facilitar el contacto entre usuarios y prestadores independientes. No presta directamente los servicios anunciados, no es empleador de los prestadores y no administra la ejecución física de los servicios contratados entre terceros.</p>
      ...
      <p>Los estados de disponibilidad representan la información registrada por los prestadores. Servicios no garantiza que un prestador continúe disponible en el momento exacto del contacto, ya que su disponibilidad puede cambiar.</p>
      ...
      <p>Los prestadores publicados operan de manera independiente. Su aparición en Servicios no implica automáticamente una relación laboral, sociedad, representación, garantía, certificación profesional ni respaldo absoluto de Servicios.</p>

      <h2>9. Comunicación externa</h2>
      <p>El contacto puede realizarse mediante servicios externos como WhatsApp o llamada telefónica. Al salir de Servicios para comunicarte por otra plataforma, también pueden aplicar las políticas y condiciones de ese proveedor.</p>

      <h2>10. Limitación de responsabilidad</h2>
      <p>Servicios busca facilitar el descubrimiento y contacto entre las partes. Sin perjuicio de los derechos reconocidos por la legislación aplicable, no garantiza la calidad, puntualidad, resultado, disponibilidad permanente, cumplimiento de acuerdos privados, seguridad absoluta de una operación entre terceros, precio final ni conducta de cada persona involucrada. Los desacuerdos sobre la ejecución del servicio deberán tratarse principalmente entre quienes celebraron el acuerdo.</p>

      <h2>11. Uso indebido</h2>
      <p>No se permite utilizar Servicios para fraude, engaño, suplantación, actividades ilegales, abuso, amenazas, información deliberadamente falsa o acciones destinadas a perjudicar a usuarios, prestadores o a la plataforma.</p>

      <h2>12. Suspensión o eliminación</h2>
      <p>Servicios podrá limitar, ocultar o retirar información cuando existan motivos razonables relacionados con fraude, abuso, información falsa, uso indebido, seguridad, cumplimiento legal o incumplimiento de las reglas de la plataforma.</p>

      <h2>13. Piloto y posibles costos para prestadores</h2>
      <p>La plataforma operará un piloto durante septiembre de 2026. La participación durante este periodo permitirá evaluar el funcionamiento y los resultados reales del servicio. Al concluir el piloto, Servicios podrá establecer un pequeño costo de participación para los prestadores, definido con base en los datos obtenidos y comunicado previamente antes de que resulte aplicable. Ningún cobro posterior se aplicará de manera automática o retroactiva sin informar sus condiciones.</p>
      ...
      <p>Servicios es un producto desarrollado por <a href={siteConfig.creator.url} target="_blank" rel="noreferrer">{siteConfig.creator.name}</a>. Su representante legal todavía no ha sido definido.</p>
